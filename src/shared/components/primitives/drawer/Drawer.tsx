...
function DrawerContent({
                         className,
                         children,
                         showHandle = true, // Default to true so you don't break existing drawers
                         handleClassName,
                         ...props
                       }: DrawerContentProps) {
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      >
        ...
        {showHandle && (
          <div
            className={cn(
              "bg-border-primary mx-auto my-2 hidden h-1 w-11 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block",
              handleClassName
            )}
          />
        )}
