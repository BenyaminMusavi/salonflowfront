...
import { TResetVerifyFormSchema } from "./resetVerifyFormSchema";

function ResetVerifyForm() {
  const { control } = useFormContext<TResetVerifyFormSchema>();
    ...
    <div className={"w-full flex justify-center"}>
      ...
      >
        ...
        <div className={"flex flex-col gap-y-4 w-full pt-5"}>
          ...
          <OtpResendButton purpose="reset-password" phone={phone} />
        </div>
      </div>
    </div>
  );
