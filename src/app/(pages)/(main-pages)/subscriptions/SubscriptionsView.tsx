...
const FAQ_ITEMS: { question: string; answer: string }[] = [
  {
    question: "صفا دقیقاً چه کاری برای سالن من انجام می‌دهد؟",
    answer:
      "صفا نوبت‌دهی آنلاین، مدیریت مشتریان و کارکنان، و گزارش‌های مالی سالن شما را در یک اپلیکیشن جمع می‌کند؛ دیگر لازم نیست هر تماس تلفنی را خودتان جواب بدهید یا دفترچه‌ی نوبت را دستی نگه دارید.",
  },
  {
    question: "با خرید اشتراک، دقیقاً به چه امکاناتی دسترسی پیدا می‌کنم؟",
    answer:
      "پنل کامل مدیریت سالن برایتان فعال می‌شود: تقویم نوبت‌ها، مدیریت خدمات و قیمت‌ها، دسترسی کارکنان، گزارش مالی و تحلیل عملکرد سالن — همه از یک‌جا.",
  },
  {
    question: "تفاوت طرح‌های اشتراک در چیست؟",
    answer:
      "امکانات همه‌ی طرح‌ها کاملاً یکسان است؛ تنها تفاوت، مدت زمان اشتراک است — هرچه طرح طولانی‌تری انتخاب کنید، هزینه‌ی ماهانه‌ی شما کمتر می‌شود.",
  },
  {
    question: "قبل از خرید می‌توانم صفا را امتحان کنم؟",
    answer:
      "بله. می‌توانید پیش از پرداخت نهایی محیط پنل را ببینید و با امکاناتش آشنا شوید تا مطمئن شوید برای کسب‌وکار شما مناسب است.",
  },
  {
    question: "اگر از اشتراک راضی نبودم، چه می‌شود؟",
    answer:
      "از بخش پشتیبانی می‌توانید درخواست لغو اشتراک ثبت کنید؛ طبق قوانین بازگشت وجه بررسی می‌شود و در صورت تأیید، مبلغ به حساب شما برمی‌گردد.",
  },
  {
    question: "برای استفاده از صفا نیاز به دانش حسابداری یا فنی دارم؟",
    answer:
      "نه. صفا برای صاحبان سالن طراحی شده، نه حسابدارها — گزارش‌های مالی به زبان ساده نمایش داده می‌شوند و راه‌اندازی اولیه فقط چند دقیقه زمان می‌برد.",
  },
  {
    question: "بعد از پایان اشتراک، اطلاعات سالنم از بین می‌رود؟",
    answer:
      "خیر، نوبت‌ها، مشتریان و گزارش‌های ثبت‌شده‌ی شما ذخیره می‌مانند؛ فقط تا وقتی تمدید نکنید، دسترسی به پنل مدیریتی موقتاً غیرفعال می‌شود.",
  },
];
